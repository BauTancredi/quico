...
export default async function ProyectoPage({ params }: Props) {
  ...
  return (
    <div className="bg-gray-50">
      <div className="mx-auto max-w-2xl px-4 lg:py-12 sm:px-6 py-6 lg:max-w-7xl lg:px-8">
      ...
      <div className="mx-auto max-w-2xl px-4 lg:py-2 sm:px-6 py-6 lg:max-w-7xl lg:px-8">
